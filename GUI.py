...
class GUIHandler(logging.Handler):
    ...
    def emit(self, record):
        ...
        elif 'start' in msg or 'used time:' in msg:
...
class Ui_PAGEANT(object):
    ...
    def retranslateUi(self, PAGEANT):
        ...
        self.label_p1.setToolTip(_translate("PAGEANT", "Index variant p-now_value threshold"))
        self.label_p1.setText(_translate("PAGEANT", "p1"))
        self.input_p1.setToolTip(_translate("PAGEANT", "Index variant p-now_value threshold"))
        self.input_p1.setText(_translate("PAGEANT", "1"))
        self.label_p2.setToolTip(_translate("PAGEANT", "Sites within clump p-now_value threshold"))
        self.label_p2.setText(_translate("PAGEANT", "p2"))
        self.input_p2.setToolTip(_translate("PAGEANT", "Sites within clump p-now_value threshold"))
...
class MyMainForm(QMainWindow, Ui_PAGEANT):
    ...
    def timerEvent(self, a0: 'QtCore.QTimerEvent') -> None:
        ...
        elif self.progress_now.value() < self.progress_value.value + 10:
